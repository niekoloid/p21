/**
	...
	SXFutyConvKanjiC.cpp						作成日：2000.04.17
	...
	２．履歴
		...
		更新		2001.09.17	K.Naono(FQS)	ヘッダ解析処理の改善対応
		更新		2001.11.19	K.Naono(FQS)	英字＋日本語の文字化け障害対応
**/
#include "stdafx.h"
#include <afx.h>
...
/* 』      【      】      ＋      －      ±      ×      　     */
 0x300F, 0x3010, 0x3011, 0xFF0B, 0xFF0D, 0x00B1, 0x00D7, 0x3000, 
/* ÷      ＝      ≠      ＜      ＞      ≦      ≧      ∞     */
...
/* →      ←      ↑      ↓      〓      　      　      　     */
 0x2192, 0x2190, 0x2191, 0x2193, 0x3013, 0x3000, 0x3000, 0x3000, 
/* 　      　      　      　      　      　      　      　     */
...
/* 　      　      　      　      　      　      　      　     */
 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 
/* ∧      ∨      ￢      ⇒      ⇔      ∀      ∃      　     */
 0x2227, 0x2228, 0xFFE2, 0x21D2, 0x21D4, 0x2200, 0x2203, 0x3000, 
/* 　      　      　      　      　      　      　      　     */
 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 
/* 　      　      ∠      ⊥      ⌒      ∂      ∇      ≡     */
 0x3000, 0x3000, 0x2220, 0x22A5, 0x2312, 0x2202, 0x2207, 0x2261, 
/* ≒      ≪      ≫      √      ∽      ∝      ∵      ∫     */
 0x2252, 0x226A, 0x226B, 0x221A, 0x223D, 0x221D, 0x2235, 0x222B, 
/* ∬      　      　      　      　      　      　      　     */
 0x222C, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 
/* Å      ‰      ♯      ♭      ♪      †      ‡      ¶     */
 0x212B, 0x2030, 0x266F, 0x266D, 0x266A, 0x2020, 0x2021, 0x00B6, 
/* 　      　      　      　      ◯      　      　      　     */
 0x3000, 0x3000, 0x3000, 0x3000, 0x25EF, 0x3000, 0x3000, 0x3000, 
/* 　      　      　      　      　      　      　      　     */
 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 
/* 　      　      　      　      　      　      　      ０     */
 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0xFF10, 
/* １      ２      ３      ４      ５      ６      ７      ８     */
 0xFF11, 0xFF12, 0xFF13, 0xFF14, 0xFF15, 0xFF16, 0xFF17, 0xFF18, 
/* ９      　      　      　      　      　      　      　     */
 0xFF19, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 
/* Ａ      Ｂ      Ｃ      Ｄ      Ｅ      Ｆ      Ｇ      Ｈ     */
...
/* Ｙ      Ｚ      　      　      　      　      　      　     */
 0xFF39, 0xFF3A, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 
/* 　      ａ      ｂ      ｃ      ｄ      ｅ      ｆ      ｇ     */
...
/* ｘ      ｙ      ｚ      　      　      　      　      ぁ     */
 0xFF58, 0xFF59, 0xFF5A, 0x3000, 0x3000, 0x3000, 0x3000, 0x3041, 
/* あ      ぃ      い      ぅ      う      ぇ      え      ぉ     */
...
/* を      ん      　      　      　      　      　      　     */
 0x3092, 0x3093, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 
/* 　      　      　      　      　      　      　      　     */
 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 
/* ァ      ア      ィ      イ      ゥ      ウ      ェ      エ     */
...
/* ベ      ペ      ホ      ボ      ポ      マ      ミ      　     */
 0x30D9, 0x30DA, 0x30DB, 0x30DC, 0x30DD, 0x30DE, 0x30DF, 0x3000, 
/* ム      メ      モ      ャ      ヤ      ュ      ユ      ョ     */
 0x30E0, 0x30E1, 0x30E2, 0x30E3, 0x30E4, 0x30E5, 0x30E6, 0x30E7, 
/* ヨ      ラ      リ      ル      レ      ロ      ヮ      ワ     */
 0x30E8, 0x30E9, 0x30EA, 0x30EB, 0x30EC, 0x30ED, 0x30EE, 0x30EF, 
/* ヰ      ヱ      ヲ      ン      ヴ      ヵ      ヶ      　     */
 0x30F0, 0x30F1, 0x30F2, 0x30F3, 0x30F4, 0x30F5, 0x30F6, 0x3000, 
/* 　      　      　      　      　      　      　      Α     */
 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x0391, 
/* Β      Γ      Δ      Ε      Ζ      Η      Θ      Ι     */
 0x0392, 0x0393, 0x0394, 0x0395, 0x0396, 0x0397, 0x0398, 0x0399, 
/* Κ      Λ      Μ      Ν      Ξ      Ο      Π      Ρ     */
 0x039A, 0x039B, 0x039C, 0x039D, 0x039E, 0x039F, 0x03A0, 0x03A1, 
/* Σ      Τ      Υ      Φ      Χ      Ψ      Ω      　     */
 0x03A3, 0x03A4, 0x03A5, 0x03A6, 0x03A7, 0x03A8, 0x03A9, 0x3000, 
/* 　      　      　      　      　      　      　      α     */
 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x03B1, 
/* β      γ      δ      ε      ζ      η      θ      ι     */
 0x03B2, 0x03B3, 0x03B4, 0x03B5, 0x03B6, 0x03B7, 0x03B8, 0x03B9, 
/* κ      λ      μ      ν      ξ      ο      π      ρ     */
 0x03BA, 0x03BB, 0x03BC, 0x03BD, 0x03BE, 0x03BF, 0x03C0, 0x03C1, 
/* σ      τ      υ      φ      χ      ψ      ω      　     */
 0x03C3, 0x03C4, 0x03C5, 0x03C6, 0x03C7, 0x03C8, 0x03C9, 0x3000, 
/* 　      　      　      　      　      　      　      　     */
 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 
/* 　      　      　      　      　      　      　      　     */
 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 
...
/* Я      　      　      　      　      　      　      　     */
 0x042F, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 
/* 　      　      　      　      　      　      　      　     */
 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 
/* а      б      в      г      д      е      ё      ж     */
 0x0430, 0x0431, 0x0432, 0x0433, 0x0434, 0x0435, 0x0451, 0x0436, 
/* з      и      й      к      л      м      н      　     */
 0x0437, 0x0438, 0x0439, 0x043A, 0x043B, 0x043C, 0x043D, 0x3000, 
/* о      п      р      с      т      у      ф      х     */
 0x043E, 0x043F, 0x0440, 0x0441, 0x0442, 0x0443, 0x0444, 0x0445, 
/* ц      ч      ш      щ      ъ      ы      ь      э     */
 0x0446, 0x0447, 0x0448, 0x0449, 0x044A, 0x044B, 0x044C, 0x044D, 
/* ю      я      　      　      　      　      　      　     */
 0x044E, 0x044F, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 
/* 　      　      　      　      　      　      　      ─     */
 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x2500, 
/* │      ┌      ┐      ┘      └      ├      ┬      ┤     */
...
/* ┷      ┿      ┝      ┰      ┥      ┸      ╂      　     */
 0x2537, 0x253F, 0x251D, 0x2530, 0x2525, 0x2538, 0x2542, 0x3000, 
/* 　      　      　      　      　      　      　      　     */
 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 
/* 　      　      　      　      　      　      　      　     */
 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 
...
/* Ⅴ      Ⅵ      Ⅶ      Ⅷ      Ⅸ      Ⅹ      　      ㍉     */
 0x2164, 0x2165, 0x2166, 0x2167, 0x2168, 0x2169, 0x3000, 0x3349, 
/* ㌔      ㌢      ㍍      ㌘      ㌧      ㌃      ㌶      ㍑     */
 0x3314, 0x3322, 0x334D, 0x3318, 0x3327, 0x3303, 0x3336, 0x3351, 
/* ㍗      ㌍      ㌦      ㌣      ㌫      ㍊      ㌻      ㎜     */
 0x3357, 0x330D, 0x3326, 0x3323, 0x332B, 0x334A, 0x333B, 0x339C, 
/* ㎝      ㎞      ㎎      ㎏      ㏄      ㎡      　      　     */
 0x339D, 0x339E, 0x338E, 0x338F, 0x33C4, 0x33A1, 0x3000, 0x3000, 
/* 　      　      　      　      　      　      ㍻      　     */
 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x337B, 0x3000, 
/* 〝      〟      №      ㏍      ℡      ㊤      ㊥      ㊦     */
...
/* ∟      ⊿      ∵      ∩      ∪      　      　      　     */
 0x221F, 0x22BF, 0x2235, 0x2229, 0x222A, 0x3000, 0x3000, 0x3000, 
/* 　      　      　      　      　      　      　      　     */
 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 
/* 　      　      　      　      　      　      　      　     */
 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 
...
/* 　      　      　      　      　      　      　      　     */
 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 
/* 　      　      　      　      　      　      　      亜     */
 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x4E9C, 
/* 唖      娃      阿      哀      愛      挨      姶      逢     */
...
/* 引      飲      淫      胤      蔭      　      　      　     */
 0x5F15, 0x98F2, 0x6DEB, 0x80E4, 0x852D, 0x3000, 0x3000, 0x3000, 
/* 院      陰      隠      韻      吋      右      宇      烏     */
...
/* 悦      謁      越      閲      榎      厭      円      　     */
 0x60A6, 0x8B01, 0x8D8A, 0x95B2, 0x698E, 0x53AD, 0x5186, 0x3000, 
/* 園      堰      奄      宴      延      怨      掩      援     */
...
/* 恢      懐      戒      拐      改      　      　      　     */
 0x6062, 0x61D0, 0x6212, 0x62D0, 0x6539, 0x3000, 0x3000, 0x3000, 
/* 魁      晦      械      海      灰      界      皆      絵     */
...
/* 岳      楽      額      顎      掛      笠      樫      　     */
 0x5CB3, 0x697D, 0x984D, 0x984E, 0x639B, 0x7B20, 0x6A2B, 0x3000, 
/* 橿      梶      鰍      潟      割      喝      恰      括     */
...
/* 旗      既      期      棋      棄      　      　      　     */
 0x65D7, 0x65E2, 0x671F, 0x68CB, 0x68C4, 0x3000, 0x3000, 0x3000, 
/* 機      帰      毅      気      汽      畿      祈      季     */
...
/* 休      及      吸      宮      弓      急      救      　     */
 0x4F11, 0x53CA, 0x5438, 0x5BAE, 0x5F13, 0x6025, 0x6551, 0x3000, 
/* 朽      求      汲      泣      灸      球      究      窮     */
...
/* 串      櫛      釧      屑      屈      　      　      　     */
 0x4E32, 0x6ADB, 0x91E7, 0x5C51, 0x5C48, 0x3000, 0x3000, 0x3000, 
/* 掘      窟      沓      靴      轡      窪      熊      隈     */
...
/* 警      軽      頚      鶏      芸      迎      鯨      　     */
 0x8B66, 0x8EFD, 0x981A, 0x9D8F, 0x82B8, 0x8FCE, 0x9BE8, 0x3000, 
/* 劇      戟      撃      激      隙      桁      傑      欠     */
...
/* 効      勾      厚      口      向      　      　      　     */
 0x52B9, 0x52FE, 0x539A, 0x53E3, 0x5411, 0x3000, 0x3000, 0x3000, 
/* 后      喉      坑      垢      好      孔      孝      宏     */
...
/* 郊      酵      鉱      砿      鋼      閤      降      　     */
 0x90CA, 0x9175, 0x9271, 0x783F, 0x92FC, 0x95A4, 0x964D, 0x3000, 
/* 項      香      高      鴻      剛      劫      号      合     */
...
/* 鮭      笹      匙      冊      刷      　      　      　     */
 0x9BAD, 0x7B39, 0x5319, 0x518A, 0x5237, 0x3000, 0x3000, 0x3000, 
/* 察      拶      撮      擦      札      殺      薩      雑     */
...
/* 支      孜      斯      施      旨      枝      止      　     */
 0x652F, 0x5B5C, 0x65AF, 0x65BD, 0x65E8, 0x679D, 0x6B62, 0x3000, 
/* 死      氏      獅      祉      私      糸      紙      紫     */
...
/* 綬      需      囚      収      周      　      　      　     */
 0x7DAC, 0x9700, 0x56DA, 0x53CE, 0x5468, 0x3000, 0x3000, 0x3000, 
/* 宗      就      州      修      愁      拾      洲      秀     */
...
/* 駿      准      循      旬      楯      殉      淳      　     */
 0x99FF, 0x51C6, 0x5FAA, 0x65EC, 0x696F, 0x6B89, 0x6DF3, 0x3000, 
/* 準      潤      盾      純      巡      遵      醇      順     */
...
/* 醸      錠      嘱      埴      飾      　      　      　     */
 0x91B8, 0x9320, 0x5631, 0x57F4, 0x98FE, 0x3000, 0x3000, 0x3000, 
/* 拭      植      殖      燭      織      職      色      触     */
...
/* 靭      笥      諏      須      酢      図      厨      　     */
 0x976D, 0x7B25, 0x8ACF, 0x9808, 0x9162, 0x56F3, 0x53A8, 0x3000, 
/* 逗      吹      垂      帥      推      水      炊      睡     */
...
/* 煽      旋      穿      箭      線      　      　      　     */
 0x717D, 0x65CB, 0x7A7F, 0x7BAD, 0x7DDA, 0x3000, 0x3000, 0x3000, 
/* 繊      羨      腺      舛      船      薦      詮      賎     */
...
/* 匝      惣      想      捜      掃      挿      掻      　     */
 0x531D, 0x60E3, 0x60F3, 0x635C, 0x6383, 0x633F, 0x63BB, 0x3000, 
/* 操      早      曹      巣      槍      槽      漕      燥     */
...
/* 諾      茸      凧      蛸      只      　      　      　     */
 0x8AFE, 0x8338, 0x51E7, 0x86F8, 0x53EA, 0x3000, 0x3000, 0x3000, 
/* 叩      但      達      辰      奪      脱      巽      竪     */
...
/* 遅      馳      築      畜      竹      筑      蓄      　     */
 0x9045, 0x99B3, 0x7BC9, 0x755C, 0x7AF9, 0x7B51, 0x84C4, 0x3000, 
/* 逐      秩      窒      茶      嫡      着      中      仲     */
...
/* 艇      訂      諦      蹄      逓      　      　      　     */
 0x8247, 0x8A02, 0x8AE6, 0x8E44, 0x9013, 0x3000, 0x3000, 0x3000, 
/* 邸      鄭      釘      鼎      泥      摘      擢      敵     */
...
/* 度      土      奴      怒      倒      党      冬      　     */
 0x5EA6, 0x571F, 0x5974, 0x6012, 0x5012, 0x515A, 0x51AC, 0x3000, 
/* 凍      刀      唐      塔      塘      套      宕      島     */
...
/* 虹      廿      日      乳      入      　      　      　     */
 0x8679, 0x5EFF, 0x65E5, 0x4E73, 0x5165, 0x3000, 0x3000, 0x3000, 
/* 如      尿      韮      任      妊      忍      認      濡     */
...
/* 肺      輩      配      倍      培      媒      梅      　     */
 0x80BA, 0x8F29, 0x914D, 0x500D, 0x57F9, 0x5A92, 0x6885, 0x3000, 
/* 楳      煤      狽      買      売      賠      陪      這     */
...
/* 枇      毘      琵      眉      美      　      　      　     */
 0x6787, 0x6BD8, 0x7435, 0x7709, 0x7F8E, 0x3000, 0x3000, 0x3000, 
/* 鼻      柊      稗      匹      疋      髭      彦      膝     */
...
/* 富      冨      布      府      怖      扶      敷      　     */
 0x5BCC, 0x51A8, 0x5E03, 0x5E9C, 0x6016, 0x6276, 0x6577, 0x3000, 
/* 斧      普      浮      父      符      腐      膚      芙     */
...
/* 抱      捧      放      方      朋      　      　      　     */
 0x62B1, 0x6367, 0x653E, 0x65B9, 0x670B, 0x3000, 0x3000, 0x3000, 
/* 法      泡      烹      砲      縫      胞      芳      萌     */
...
/* 堀      幌      奔      本      翻      凡      盆      　     */
 0x5800, 0x5E4C, 0x5954, 0x672C, 0x7FFB, 0x51E1, 0x76C6, 0x3000, 
/* 摩      磨      魔      麻      埋      妹      昧      枚     */
...
/* 鑓      愉      愈      油      癒      　      　      　     */
 0x9453, 0x6109, 0x6108, 0x6CB9, 0x7652, 0x3000, 0x3000, 0x3000, 
/* 諭      輸      唯      佑      優      勇      友      宥     */
...
/* 踊      遥      陽      養      慾      抑      欲      　     */
 0x8E0A, 0x9065, 0x967D, 0x990A, 0x617E, 0x6291, 0x6B32, 0x3000, 
/* 沃      浴      翌      翼      淀      羅      螺      裸     */
...
/* 漣      煉      簾      練      聯      　      　      　     */
 0x6F23, 0x7149, 0x7C3E, 0x7DF4, 0x806F, 0x3000, 0x3000, 0x3000, 
/* 蓮      連      錬      呂      魯      櫓      炉      賂     */
...
/* 湾      碗      腕      　      　      　      　      　     */
 0x6E7E, 0x7897, 0x8155, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 
/* 　      　      　      　      　      　      　      　     */
 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 
/* 　      　      　      　      　      　      　      　     */
 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 
...
/* 　      　      　      　      　      　      　      　     */
 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 
/* 　      　      　      　      　      　      　      弌     */
 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x5F0C, 
/* 丐      丕      个      丱      丶      丼      丿      乂     */
...
/* 傀      傚      傅      傴      傲                             */
 0x5080, 0x509A, 0x5085, 0x50B4, 0x50B2, 0x0000//終端
};

static int KanjiTable3[] = {
/* 漾      漓      滷      澆      潺      潸      澁      澀     */
...
/* 炬      炸      炳      炮      烟      烋      烝      　     */
 0x70AC, 0x70B8, 0x70B3, 0x70AE, 0x70DF, 0x70CB, 0x70DD, 0x3000, 
/* 烙      焉      烽      焜      焙      煥      煕      熈     */
...
/* 璧      瓊      瓏      瓔      珱      　      　      　     */
 0x74A7, 0x74CA, 0x74CF, 0x74D4, 0x73F1, 0x3000, 0x3000, 0x3000, 
/* 瓠      瓣      瓧      瓩      瓮      瓲      瓰      瓱     */
...
/* 痊      痒      痙      痣      痞      痾      痿      　     */
 0x75CA, 0x75D2, 0x75D9, 0x75E3, 0x75DE, 0x75FE, 0x75FF, 0x3000, 
/* 痼      瘁      痰      痺      痲      痳      瘋      瘍     */
...
/* 碾      碼      磅      磊      磬      　      　      　     */
 0x78BE, 0x78BC, 0x78C5, 0x78CA, 0x78EC, 0x3000, 0x3000, 0x3000, 
/* 磧      磚      磽      磴      礇      礒      礑      礙     */
...
/* 窗      窕      窘      窖      窩      竈      窰      　     */
 0x7A97, 0x7A95, 0x7A98, 0x7A96, 0x7AA9, 0x7AC8, 0x7AB0, 0x3000, 
/* 窶      竅      竄      窿      邃      竇      竊      竍     */
...
/* 糲      糴      糶      糺      紆      　      　      　     */
 0x7CF2, 0x7CF4, 0x7CF6, 0x7CFA, 0x7D06, 0x3000, 0x3000, 0x3000, 
/* 紂      紜      紕      紊      絅      絋      紮      紲     */
...
/* 繆      繦      縻      縵      縹      繃      縷      　     */
 0x7E46, 0x7E66, 0x7E3B, 0x7E35, 0x7E39, 0x7E43, 0x7E37, 0x3000, 
/* 縲      縺      繧      繝      繖      繞      繙      繚     */
...
/* 脛      脩      脣      脯      腋      　      　      　     */
 0x811B, 0x8129, 0x8123, 0x812F, 0x814B, 0x3000, 0x3000, 0x3000, 
/* 隋      腆      脾      腓      腑      胼      腱      腮     */
...
/* 艀      艙      艘      艝      艚      艟      艤      　     */
 0x8240, 0x8259, 0x8258, 0x825D, 0x825A, 0x825F, 0x8264, 0x3000, 
/* 艢      艨      艪      艫      舮      艱      艷      艸     */
...
/* 蓼      蕀      蕣      蕘      蕈      　      　      　     */
 0x84FC, 0x8540, 0x8563, 0x8558, 0x8548, 0x3000, 0x3000, 0x3000, 
/* 蕁      蘂      蕋      蕕      薀      薤      薈      薑     */
...
/* 蛉      蠣      蚫      蛔      蛞      蛩      蛬      　     */
 0x86C9, 0x8823, 0x86AB, 0x86D4, 0x86DE, 0x86E9, 0x86EC, 0x3000, 
/* 蛟      蛛      蛯      蜒      蜆      蜈      蜀      蜃     */
...
/* 褸      襌      褝      襠      襞      　      　      　     */
 0x8938, 0x894C, 0x891D, 0x8960, 0x895E, 0x3000, 0x3000, 0x3000, 
/* 襦      襤      襭      襪      襯      襴      襷      襾     */
...
/* 諄      諍      諂      諚      諫      諳      諧      　     */
 0x8AC4, 0x8ACD, 0x8AC2, 0x8ADA, 0x8AEB, 0x8AF3, 0x8AE7, 0x3000, 
/* 諤      諱      謔      諠      諢      諷      諞      諛     */
...
/* 蹂      踵      踰      踴      蹊      　      　      　     */
 0x8E42, 0x8E35, 0x8E30, 0x8E34, 0x8E4A, 0x3000, 0x3000, 0x3000, 
/* 蹇      蹉      蹌      蹐      蹈      蹙      蹤      蹠     */
...
/* 輾      轌      轉      轆      轎      轗      轜      　     */
 0x8F3E, 0x8F4C, 0x8F49, 0x8F46, 0x8F4E, 0x8F57, 0x8F5C, 0x3000, 
/* 轢      轣      轤      辜      辟      辣      辭      辯     */
...
/* 鋩      錏      鋺      鍄      錮      　      　      　     */
 0x92E9, 0x930F, 0x92FA, 0x9344, 0x932E, 0x3000, 0x3000, 0x3000, 
/* 錙      錢      錚      錣      錺      錵      錻      鍜     */
...
/* 閂      閇      閊      閔      閖      閘      閙      　     */
 0x9582, 0x9587, 0x958A, 0x9594, 0x9596, 0x9598, 0x9599, 0x3000, 
/* 閠      閨      閧      閭      閼      閻      閹      閾     */
...
/* 顏      顋      顫      顯      顰      　      　      　     */
 0x984F, 0x984B, 0x986B, 0x986F, 0x9870, 0x3000, 0x3000, 0x3000, 
/* 顱      顴      顳      颪      颯      颱      颶      飄     */
...
/* 騙      騫      騷      驅      驂      驀      驃      　     */
 0x9A19, 0x9A2B, 0x9A37, 0x9A45, 0x9A42, 0x9A40, 0x9A43, 0x3000, 
/* 騾      驕      驍      驛      驗      驟      驢      驥     */
...
/* 鵁      鴿      鴾      鵆      鵈      　      　      　     */
 0x9D41, 0x9D3F, 0x9D3E, 0x9D46, 0x9D48, 0x3000, 0x3000, 0x3000, 
/* 鵝      鵞      鵤      鵑      鵐      鵙      鵲      鶉     */
...
/* 黜      點      黝      黠      黥      黨      黯      　     */
 0x9EDC, 0x9EDE, 0x9EDD, 0x9EE0, 0x9EE5, 0x9EE8, 0x9EEF, 0x3000, 
/* 黴      黶      黷      黹      黻      黼      黽      鼇     */
...
/* 槇      遙      瑤      凜      熙      　      　      　     */
 0x69C7, 0x9059, 0x7464, 0x51DC, 0x7199, 0x3000, 0x3000, 0x3000, 
/* 　      　      　      　      　      　      　      　     */
 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 
/* 　      　      　      　      　      　      　      　     */
 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 
...
/* 喆      坙      坥      垬      埈      埇      﨏      　     */
 0x5586, 0x5759, 0x5765, 0x57AC, 0x57C8, 0x57C7, 0xFA0F, 0x3000, 
/* 塚      增      墲      夋      奓      奛      奝      奣     */
...
/* 煇      凞      燁      燾      犱      　      　      　     */
 0x7147, 0xFA15, 0x71C1, 0x71FE, 0x72B1, 0x3000, 0x3000, 0x3000, 
/* 犾      猤      猪      獷      玽      珉      珖      珣     */
...
/* 荿      菇      菶      葈      蒴      蕓      蕙      　     */
 0x837F, 0x83C7, 0x83F6, 0x8448, 0x84B4, 0x8553, 0x8559, 0x3000, 
/* 蕫      﨟      薰      蘒      﨡      蠇      裵      訒     */
...
/* 鵰      鵫      鶴      鸙      黑      　      　      ⅰ     */
 0x9D70, 0x9D6B, 0xFA2D, 0x9E19, 0x9ED1, 0x3000, 0x3000, 0x2170, 
/* ⅱ      ⅲ      ⅳ      ⅴ      ⅵ      ⅶ      ⅷ      ⅸ     */
 0x2171, 0x2172, 0x2173, 0x2174, 0x2175, 0x2176, 0x2177, 0x2178, 
/* ⅹ      ￢      ￤      ＇      ＂                             */
 0x2179, 0xFFE2, 0xFFE4, 0xFF07, 0xFF02, 0x0000 
};

static int KanjiTable4[] = {
/* ⅰ      ⅱ      ⅲ      ⅳ      ⅴ      ⅵ      ⅶ      ⅷ     */
...
/* 偆      偰      偂      傔      僴      僘      兊      　     */
 0x5046, 0x5070, 0x5042, 0x5094, 0x50F4, 0x50D8, 0x514A, 0x3000, 
/* 兤      冝      冾      凬      刕      劜      劦      勀     */
...
/* 汯      泚      洄      涇      浯      　      　      　     */
 0x6C6F, 0x6CDA, 0x6D04, 0x6D87, 0x6D6F, 0x3000, 0x3000, 0x3000, 
/* 涖      涬      淏      淸      淲      淼      渹      湜     */
...
/* 砡      硎      硤      硺      礰      礼      神      　     */
 0x7821, 0x784E, 0x7864, 0x787A, 0x7930, 0xFA18, 0xFA19, 0x3000, 
/* 祥      禔      福      禛      竑      竧      靖      竫     */
...
/* 餧      館      馞      驎      髙      　      　      　     */
 0x9927, 0xFA2C, 0x999E, 0x9A4E, 0x9AD9, 0x3000, 0x3000, 0x3000, 
/* 髜      魵      魲      鮏      鮱      鮻      鰀      鵰     */
 0x9ADC, 0x9B75, 0x9B72, 0x9B8F, 0x9BB1, 0x9BBB, 0x9C00, 0x9D70, 
/* 鵫      鶴      鸙      黑                                     */
 0x9D6B, 0xFA2D, 0x9E19, 0x9ED1, 0x0000//終端
};

static int KanjiTable1[] = {
/* 僉      僊      傳      僂      僖      僞      僥      僭     */
...
/* 凅      凉      凛      几      處      凩      凭      　     */
 0x51C5, 0x51C9, 0x51DB, 0x51E0, 0x8655, 0x51E9, 0x51ED, 0x3000, 
/* 凰      凵      凾      刄      刋      刔      刎      刧     */
...
/* 咥      咬      哄      哈      咨      　      　      　     */
 0x54A5, 0x54AC, 0x54C4, 0x54C8, 0x54A8, 0x3000, 0x3000, 0x3000, 
/* 咫      哂      咤      咾      咼      哘      哥      哦     */
...
/* 噎      噐      營      嘴      嘶      嘲      嘸      　     */
 0x564E, 0x5650, 0x71DF, 0x5634, 0x5636, 0x5632, 0x5638, 0x3000, 
/* 噫      噤      嘯      噬      噪      嚆      嚀      嚊     */
...
/* 奢      奠      奧      奬      奩      　      　      　     */
 0x5962, 0x5960, 0x5967, 0x596C, 0x5969, 0x3000, 0x3000, 0x3000, 
/* 奸      妁      妝      佞      侫      妣      妲      姆     */
...
/* 孰      孳      孵      學      斈      孺      宀      　     */
 0x5B70, 0x5B73, 0x5B75, 0x5B78, 0x6588, 0x5B7A, 0x5B80, 0x3000, 
/* 它      宦      宸      寃      寇      寉      寔      寐     */
...
/* 廁      廂      廈      廐      廏      　      　      　     */
 0x5EC1, 0x5EC2, 0x5EC8, 0x5ED0, 0x5ECF, 0x3000, 0x3000, 0x3000, 
/* 廖      廣      廝      廚      廛      廢      廡      廨     */
...
/* 忸      忱      忝      悳      忿      怡      恠      　     */
 0x5FF8, 0x5FF1, 0x5FDD, 0x60B3, 0x5FFF, 0x6021, 0x6060, 0x3000, 
/* 怙      怐      怩      怎      怱      怛      怕      怫     */
...
/* 戉      戍      戌      戔      戛      　      　      　     */
 0x6209, 0x620D, 0x620C, 0x6214, 0x621B, 0x3000, 0x3000, 0x3000, 
/* 戞      戡      截      戮      戰      戲      戳      扁     */
...
/* 捶      掣      掏      掉      掟      掵      捫      　     */
 0x6376, 0x63A3, 0x638F, 0x6389, 0x639F, 0x63B5, 0x636B, 0x3000, 
/* 捩      掾      揩      揀      揆      揣      揉      插     */
...
/* 曁      暹      曉      暾      暼      　      　      　     */
 0x66C1, 0x66B9, 0x66C9, 0x66BE, 0x66BC, 0x3000, 0x3000, 0x3000, 
/* 曄      暸      曖      曚      曠      昿      曦      曩     */
...
/* 栞      框      栩      桀      桍      栲      桎      　     */
 0x681E, 0x6846, 0x6829, 0x6840, 0x684D, 0x6832, 0x684E, 0x3000, 
/* 梳      栫      桙      档      桷      桿      梟      梏     */
...
/* 檍      檠      檄      檢      檣      　      　      　     */
 0x6A8D, 0x6AA0, 0x6A84, 0x6AA2, 0x6AA3, 0x3000, 0x3000, 0x3000, 
/* 檗      蘗      檻      櫃      櫂      檸      檳      檬     */
...
/* 毋      毓      毟      毬      毫      毳      毯      　     */
 0x6BCB, 0x6BD3, 0x6BDF, 0x6BEC, 0x6BEB, 0x6BF3, 0x6BEF, 0x3000, 
/* 麾      氈      氓      气      氛      氤      氣      汞     */
...
/* 滲      漱      滯      漲      滌                             */
 0x6EF2, 0x6F31, 0x6EEF, 0x6F32, 0x6ECC, 0x0000//終端
};
...
/**
	...
	２．インターフェイス
		void	 SXFutyConvKanjiC::SXFutyConvKanjiC()
	...
	３．履歴
		...
		作成		2000.04.17	宮園(FQS)	なし。
**/
SXFutyConvKanjiC::SXFutyConvKanjiC()
{
}
...
/**
	...
	２．インターフェイス
		void	 SXFutyConvKanjiC::ConvKanji(char *Direction, 
											char *InChar, 
											char *OutChar)
...
**/
/*
int SXFutyConvKanjiC::ConvKanji(char *Direction, char *InChar, char *OutChar)
{
	if( Direction == NULL || InChar == NULL || OutChar == NULL ) {
		return 1 ;
	}

	short n1,n2;
	short n3;
	int   i,num,p1,q1,r1,OutCode,kanji,count,rtn=0,TableKind,KanjiTable2[1344];
	char  buf[5],pp[3],*dmy;

	static char start[]	= {"\\X2\\"};
	static char end[]	= {"\\X0\\"};
	static char start1[]= {"\\x2\\"};
	static char end1[]	= {"\\x0\\"};

	if (strncmp(Direction,DEF_FROMJIS,7)==0){
		num = strlen(InChar);
		memset(buf,0x00,5);memset(OutChar,0x00,1);
		kanji = 0;count = 0;
		while (count < num){
			n1 = *InChar & 0xff;
			count++;
...
//	ADD(S)	ヘッダ解析処理の改善対応	K.Naono		01.09.17
				else if(n1 == 0x005C)
				{
					strncat(OutChar,"\\\\",2);
				}
//	ADD(E)	ヘッダ解析処理の改善対応	K.Naono		01.09.17
				else{
					strncat(OutChar,InChar,1);
				}
				InChar = InChar + 1;
			}
			else if (n1 > 0x7f && n1 < 0xA0){
				if (kanji == 0){
					strncat(OutChar,start,4);
					kanji = 1;
				}
				n2 = *(InChar+1) & 0xff;
				InChar = InChar + 2;
				if (n2 == 0x00){
					...
					if (n1 < 0x99){
						...
						q1 = p1*16*16 + n2;
						r1 = q1 - (p1+1)*(0x40);
						OutCode = KanjiTable[r1];
					}
					else {
						p1 = n1 - 0x99;
						q1 = p1*16*16 + n2;
						r1 = q1 - (p1+1)*(0x40);
						AddTable(KanjiTable2);
						OutCode = KanjiTable2[r1];
					}
					sprintf(buf,"%4.4X",OutCode);
					strcat(OutChar,buf);
					count++;
				}
			}
			else if (n1 > 0x9F && n1 < 0xE0){
				if (kanji == 0){
					strncat(OutChar,start,4);
					kanji = 1;
				}
				InChar = InChar + 1;
				r1 = n1 - (0xA0);
				OutCode = KanaTable[r1];
				sprintf(buf,"%4.4X",OutCode);
				strcat(OutChar,buf);
			}
			else if (n1 >= 0xE0 && n1 <= 0xEE){
				if (kanji == 0){
					strncat(OutChar,start,4);
					kanji = 1;
				}
				...
				q1 = p1*16*16 + n2;
				r1 = q1 - (p1+1)*(0x40);
				OutCode = KanjiTable3[r1];
				sprintf(buf,"%4.4X",OutCode);
				strcat(OutChar,buf);
				count++;
			}
			else if (n1 >= 0xFA && n1 <= 0xFC){
				if (kanji == 0){
					strncat(OutChar,start,4);
					kanji = 1;
				}
		...
		if (kanji == 1) strncat(OutChar,end,4);
	}
	else if (strncmp(Direction,DEF_ToJIS,5) == 0){
		memset(OutChar,0x00,1);kanji = 0;
		num = strlen(InChar);count = 0;
		while(count < num){
			n3 = *InChar & 0xff;
			if (strncmp(InChar,start,4) == 0 || strncmp(InChar,start1,4) == 0){
				kanji = 1;
				InChar = InChar + 4;
				count  = count  + 4;
			}
			else if (strncmp(InChar,end,4) == 0 || strncmp(InChar,end1,4) == 0){
				kanji = 0;
				InChar = InChar + 4;
				count  = count  + 4;
//	ADD(S)	障害対応	K.Naono		01.11.19
				n3 = *InChar & 0xff;
//	ADD(E)	障害対応	K.Naono		01.11.19
			}
			if (kanji == 0){
				strncat(OutChar,InChar,1);
				if(n3 == 0x0027)
...
//	ADD(S)	ヘッダ解析処理の改善対応	K.Naono		01.09.17
				else if( n3 == 0x005C && ((InChar+1)[0] & 0xff) == 0x005C ) {
					InChar = InChar + 2;
					count++ ;
				}
//	ADD(E)	ヘッダ解析処理の改善対応	K.Naono		01.09.17
				...
				memset(buf,0x00,5);strcat(buf,"0x");
				strncat(&buf[2],InChar,2);
				p1 = strtol(buf,&dmy,0);n1 = (short)p1;
				memset(buf,0x00,5);strcat(buf,"0x");
				strncat(&buf[2],InChar+2,2);
				q1 = strtol(buf,&dmy,0);n2 = (short)q1;
				InChar = InChar + 4;
				count  = count  + 4;
				r1 = p1*16*16 + q1;
				i = 0;
				...
				while(1){
					if (TableKind == 0){
						if (KanjiTable[i] != 0x0000){
							if (KanjiTable[i] == r1){
								p1 = i/(12*16);
								q1 = i + 0x8140;
								r1 = q1 + (p1)*(0x40);
								n1 = r1/(16*16);n2 = (r1-n1*16*16);
								pp[0] = (char)n1;
								pp[1] = (char)n2;
								strncat(OutChar,pp,2);
								break;
							}
							i++;
						}
					...
					{
						if (AnkTABLE[i] != 0x0000 || i == 0){
							if (AnkTABLE[i] == r1){
								n1 = i;
								pp[0] = (char)n1;
								strncat(OutChar,pp,1);
								rtn = 0;
								break;
							}
						i++;
...
int SXFutyConvKanjiC::AddTable(int KanjiTable[])
{
	int   i;

	for (i = 0;i <= KanjiTable1[i]; i++){
		KanjiTable[i] = KanjiTable1[i];
	}
...
/**
	...
	引数	：	型		引数名		内容
				char*	InChar		変換前文字列
				char*	OutChar		変換後文字列
				size_t	OutCharSize	変換後文字列を受け取るバッファサイズ
...
**/
//int SXFutyConvKanjiC::ToJIS(char *InChar, char *OutChar)
int SXFutyConvKanjiC::ToJIS(char *InChar, char *OutChar,size_t OutCharSize)
{
	short n1,n2;
	short n3;
	int   i,p1,q1,r1,kanji,rtn=0,TableKind,KanjiTable2[1344];
	size_t num,count;
	char  buf[5],pp[3],*dmy;
...
//	ADD(E)	障害対応	K.Naono		01.11.19
		...
		if (kanji == 0){
			...
			//strncat(OutChar,InChar,1);
			strncat_s(OutChar,OutCharSize,InChar,1);
			if(n3 == 0x0027)
			{
				InChar = InChar + 2;
//	ADD(S)	ヘッダ解析処理の改善対応	K.Naono		01.09.17
...
//	ADD(E)	ヘッダ解析処理の改善対応	K.Naono		01.09.17
		...
		//	MOD(S)	JPCERT/CC 指摘 脆弱性対応	T.Matsushima	2015.04.27
			//memset(buf,0x00,5);strcat(buf,"0x");
			//strncat(&buf[2],InChar,2);
			memset(buf,0x00,5);strcat_s(buf,_countof(buf),"0x");
			strncat_s(buf,_countof(buf),InChar,2);
		...
		//	MOD(S)	JPCERT/CC 指摘 脆弱性対応	T.Matsushima	2015.04.27
			...
			//strncat(&buf[2],InChar+2,2);
			memset(buf,0x00,5);strcat_s(buf,_countof(buf),"0x");
			strncat_s(buf,_countof(buf),InChar+2,2);
		//	MOD(E)	JPCERT/CC 指摘 脆弱性対応	T.Matsushima	2015.04.27
			q1 = strtol(buf,&dmy,0);n2 = (short)q1;
			InChar = InChar + 4;
			count  = count  + 4;
				...
				if (TableKind == 0){
					if (KanjiTable[i] != 0x0000){
						if (KanjiTable[i] == r1){
							...
							//	JPCERT/CC 指摘 脆弱性対応	T.Matsushima	2015.04.27
							//strncat(OutChar,pp,2);
							strncat_s(OutChar,OutCharSize,pp,2);
							break;
						}
						i++;
					}
						...
						i = 0;
						ZeroMemory(KanjiTable2, sizeof(KanjiTable2)) ;
						AddTable(KanjiTable2);
						TableKind = 1;
					}
				}
				...
				else if (TableKind == 4)
				{
					if (AnkTABLE[i] != 0x0000 || i == 0){
						if (AnkTABLE[i] == r1){
							...
							//	JPCERT/CC 指摘 脆弱性対応	T.Matsushima	2015.04.27
							//strncat(OutChar,pp,1);
							strncat_s(OutChar,OutCharSize,pp,1);
							rtn = 0;
							break;
						}
					i++;
...
/**
	...
	１．機能概要
		JisからUnicodeからコードの変換

	２．インターフェイス
		void	 SXFutyConvKanjiC::FromJIS(
											char *InChar,
											char *OutChar,
											size_t OutCharSize)
	...
	３．履歴
		...
		更新		2015.04.27	T.Matsushima	JPCERT/CC 指摘 脆弱性対応
**/
//int SXFutyConvKanjiC::FromJIS(char *InChar, char *OutChar)
int SXFutyConvKanjiC::FromJIS(char *InChar, char *OutChar,size_t OutCharSize)
{
	short n1,n2;
	int   p1,q1,r1,OutCode,kanji,rtn=0,KanjiTable2[1344];
	size_t num,count;
	char  buf[5];
	...
	while (count < num){
		...
		if (n1 < 0x80 ){
			if (kanji == 1){
				//	JPCERT/CC 指摘 脆弱性対応	T.Matsushima	2015.04.27
				//strncat(OutChar,end,4);
				strncat_s(OutChar,OutCharSize,end,4);
				kanji = 0;
			}
			if(n1 == 0x27) 
			{
				//	JPCERT/CC 指摘 脆弱性対応	T.Matsushima	2015.04.27
				//strncat(OutChar,"''",2);
				strncat_s(OutChar,OutCharSize,"''",2);
			}
//	ADD(S)	ヘッダ解析処理の改善対応	K.Naono		01.09.17
			else if(n1 == 0x005C)
			{
...
//	ADD(E)	ヘッダ解析処理の改善対応	K.Naono		01.09.17
			...
			if (kanji == 0){
				//	JPCERT/CC 指摘 脆弱性対応	T.Matsushima	2015.04.27
				//strncat(OutChar,start,4);
				strncat_s(OutChar,OutCharSize,start,4);
				kanji = 1;
			}
			n2 = *(InChar+1) & 0xff;
			InChar = InChar + 2;
			...
			//	MOD(S)	JPCERT/CC 指摘 脆弱性対応	T.Matsushima	2015.04.27
				//sprintf(buf,"%4.4X",OutCode);
				//strcat(OutChar,buf);
				sprintf_s(buf,_countof(buf),"%4.4X",OutCode);
				strcat_s(OutChar,OutCharSize,buf);
			//	MOD(E)	JPCERT/CC 指摘 脆弱性対応	T.Matsushima	2015.04.27
				count++;
			}
		}
	...
	//	JPCERT/CC 指摘 脆弱性対応	T.Matsushima	2015.04.27
	//if (kanji == 1) strncat(OutChar,end,4);
	if (kanji == 1) strncat_s(OutChar,OutCharSize,end,4);
