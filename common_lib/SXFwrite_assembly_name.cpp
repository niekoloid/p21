/**
	...
	２．インターフェース
	int SXFwrite_assembly_name_AP202(int IN_assem_type, void *IN_str)
	引数:	型				引数名				内容
...
__declspec(dllexport) int WINAPI SXFwrite_assembly_name_AP202(int IN_assem_type, void *IN_str)
{
