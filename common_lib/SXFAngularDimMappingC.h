/**
	...
	SXFAngularDimMappingC.h								作成日：2000.4.18
...
#if !defined(AFX_SXFANGULARDIMMAPPINGC_H__1F88C680_149F_11D4_A76E_00000EB03267__INCLUDED_)
#define AFX_SXFANGULARDIMMAPPINGC_H__1F88C680_149F_11D4_A76E_00000EB03267__INCLUDED_
...
public:
	...
	int MappingStruct(AngularDim_Struct IN_Struct,int IN_AssemType);
	SXFAngularDimMappingC();
	SXFAngularDimMappingC(SXFTableManagerC* IN_TableManager);
	virtual ~SXFAngularDimMappingC();
private:
	//////////////////////////////////////
	//インスタンスID
	//////////////////////////////////////
...
#endif // !defined(AFX_SXFANGULARDIMMAPPINGC_H__1F88C680_149F_11D4_A76E_00000EB03267__INCLUDED_)
