/**
	...
	SXFMapF_LINERDIMC.cpp						作成日：2000.04.17
...
/**
	...
	２．インターフェイス
		void	SXFMapF_LINERDIMC::SXFMapF_LINERDIMC()
	...
	作成		2000.04.17	
**/
SXFMapF_LINERDIMC::SXFMapF_LINERDIMC()
{
	m_sun_x1 = 0.0;
	m_sun_y1 = 0.0;
	m_sun_x2 = 0.0;
...
BOOL SXFMapF_LINERDIMC::GetStructData( LinearDim_Struct* INOUT_Struct )
{
...
/**
	...
	２．インターフェイス
		void	SXFMapF_LINERDIMC::SetArrFlag(
	...
	作成		2000.04.17	
**/
BOOL SXFMapF_LINERDIMC::SetArrFlag(  
				int IN_term1,	//矢印１の有り無しフラグ
				int IN_term2,	//矢印２の有り無しフラグ
				double IN_sun_x1,	//寸法線の始点
				double IN_sun_y1,	//寸法線の始点
