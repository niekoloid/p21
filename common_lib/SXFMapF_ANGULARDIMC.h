/**
	...
	SXFMapF_ANGULARDIMC.h						作成日：2000.04.17
...
#ifndef _SXFMapF_ANGULARDIMC_CLASS_
#define _SXFMapF_ANGULARDIMC_CLASS_

class SXFMapF_ANGULARDIMC : 
...
public :
	...
	BOOL GetStructData( AngularDim_Struct* INOUT_Struct );
