/**
	...
	SXFE_diameter_dimensionC.cpp								作成日：2000.4.18
...
/**
	...
	２．インターフェース
	void	SXFE_diameter_dimensionC(SXFD_StrC *str,SXFD_AggrC *aggr)
	引数:	型								引数名				内容
...
**/
SXFE_diameter_dimensionC::SXFE_diameter_dimensionC(SXFD_StrC *str,SXFD_AggrC *aggr){
	...
	m_Entity = DEF_DIAMETER_DIMENSION;
...
**/
void	SXFE_diameter_dimensionC::WriteP21(SXFPart21FileC *IN_file) {
	if(m_Flg){
		...
		IN_file->WriteString("DIAMETER_DIMENSION()\n");
