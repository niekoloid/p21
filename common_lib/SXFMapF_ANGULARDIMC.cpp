/**
	...
	SXFMapF_ANGULARDIMC.cpp						作成日：2000.04.17
...
/**
	...
	２．インターフェイス
		void	SXFMapF_ANGULARDIMC::SXFMapF_ANGULARDIMC()
	...
	作成		2000.04.17	
**/
SXFMapF_ANGULARDIMC::SXFMapF_ANGULARDIMC()
{
	m_sun_x = 0.0;
	m_sun_y = 0.0;
	m_sun_radius = 0.0;
...
/**
	...
	２．インターフェイス
		void	SXFMapF_ANGULARDIMC::GetStructData()

	引数 ：	型					引数名			内容
			AngularDim_Struct* 	INOUT_Struct    構造体
	...
	作成		2000.04.17	
**/
BOOL SXFMapF_ANGULARDIMC::GetStructData( AngularDim_Struct* INOUT_Struct )
{
...
/**
	...
	作成		2000.04.17	
**/
BOOL SXFMapF_ANGULARDIMC::SetArrFlag(  
				int IN_term1,	//矢印１の有り無しフラグ
				int IN_term2,	//矢印２の有り無しフラグ
				double IN_sun_x,	//寸法線の原点（円弧中心X)
				double IN_sun_y,	//寸法線の原点（円弧中心Y）
