/**
	...
	SXFE_radius_dimensionC.cpp								作成日：2000.4.18
...
/**
	...
	２．インターフェース
	void	SXFE_radius_dimensionC(SXFD_StrC *str,SXFD_AggrC *aggr)
	引数:	型				引数名			内容
...
**/
SXFE_radius_dimensionC::SXFE_radius_dimensionC(SXFD_StrC *str,SXFD_AggrC *aggr){
...
/**
	...
	２．インターフェース
	void	SXFE_radius_dimensionC::WriteP21(SXFPart21FileC *IN_file)
	引数:	型				引数名			内容
...
void	SXFE_radius_dimensionC::WriteP21(SXFPart21FileC *IN_file) {
	if(m_Flg){
		...
		IN_file->WriteString("RADIUS_DIMENSION()\n");
