/**
	...
	SXFMapF_BALLOONC.cpp					作成日：2000.04.17
...
/**
	...
	２．インターフェイス
		void	SXFMapF_BALLOONC::SXFMapF_BALLOONC()
	...
	作成		2000.04.17	
**/
SXFMapF_BALLOONC::SXFMapF_BALLOONC()
{
	m_vertex_number = 0;
...
/**
	...
	２．インターフェイス
		void	SXFMapF_BALLOONC::GetStructData()

	引数 ：	型				引数名			内容
			Balloon_Struct 	INOUT_Struct    構造体
	...
	作成		2000.04.17	
**/
BOOL SXFMapF_BALLOONC::GetStructData( Balloon_Struct* INOUT_Struct )
{
	...
	INOUT_Struct->center_x = m_center_x;
	INOUT_Struct->center_y = m_center_y;
	INOUT_Struct->radius   = m_radius;
...
/**
	...
	２．インターフェイス
		void	SXFMapF_BALLOONC::SetVertex()
	...
	作成		2000.04.17	
**/
BOOL SXFMapF_BALLOONC::SetVertex(
